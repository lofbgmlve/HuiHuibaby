...
<form name="updateForm" id="updateForm" action="updateProcess.mvc"
	method="post" 
	${ not empty community.communityimage ?  "" : "enctype='multipart/form-data'"}>
	...
	<tr>
		...
		<td class="readTd">
			<input type="text" name="nickName" id="nickName" size="30" 
				maxlength="10" value="${ community.nickname }"/>
		</td>
	</tr>
	<tr>
		...
		<td class="readTd" colspan="3">
			<input type="text" name="title" id="title" size="50" 
				maxlength="50" value="${ community.subject }"/>
		</td>				
	</tr>
	<tr>
		...
		<td class="readTd" colspan="3">
			<textarea name="content" id="content" rows="20" 
				cols="72">${ community.content } </textarea>
		</td>				
	</tr>
	<tr>
		...
		<td class="readTd" colspan="3">
			<input type="image" name="image" id="image" size="50" 
				${ empty community.communityimage ? "" : "disabled" } />
		</td>				
	</tr>
	<tr>
			<td colspan="4">&nbsp;</td></tr>
