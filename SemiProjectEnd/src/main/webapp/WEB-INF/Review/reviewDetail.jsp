...
<article>
	...
	<input type="hidden" name="no" id="no" value="${ review.rNo }"/>
...
<table class="contentTable">
	<tr>
		<td colspan="4" class="boardTitle"><h2>리뷰 상세보기</h2></td>
	</tr>
	<tr>
		<td colspan="4">&nbsp;</td>
	</tr>
	<tr>
		...
		<td class="contentTdSpan" colspan="3">${ review.rSubject }</td>		
	</tr>
	<tr>
		<td class="contentTh">글쓴이</td>
		<td class="contentTd">${ review.rNickname }</td>
		<td class="contentTh">작성일</td>
		<td class="contentTd"><fmt:formatDate value="${ review.rDate }" 
	...
	<tr>
		...
		<c:if test="${ not empty review.rImage }">
			<a href="upload/${ r.rImage }">이미지 다운로드</a><br/>
			<a href="imageDownload.mvc?imageName=${ r.rImage }">이미지 다운로드</a>
		</c:if>
		</td>		
	</tr>
	<tr>		
	...
	<tr>
		<td colspan="4" class="replyHeader">
			...
			<div id="replyTitle"><h3>리뷰에 대한 댓글 리스트</h3></div>
		</td>
	</tr>
	...
	<tr id="replyList">
		<td colspan="4">		
		<table id="replyTable">
			<c:forEach var="reply" items="${ reviewreplyList }" >
				<tr id="reply_${ reply.no }">
					<td>									
					<div class="replyUser">						
						<span class="member">${ reviewreply.writer }</span>	
					</div>
					<div class="replyModify">
						<span class="reply_date">
							<fmt:formatDate value="${ reviewreply.regDate }" 
								pattern="yyyy-MM-dd" /></span>
						<a href="#" class="modifyReply" data-no="${ reviewreply.no }">
							<img src="images/reply_btn_modify.gif" alt="댓글 수정하기"/></a>
						<a href="#" class=deleteReply data-no="${ reviewreply.no }">
							<img src="images/reply_btn_delete.gif" alt="댓글 삭제하기"/></a>
						<a href="javascript:reportReply('${ reviewreply.no }')">
							<img src="images/reply_btn_notify.gif" alt="신고하기"/></a>
					</div>	
					<div class="replyContent" id="div_${ reviewreply.no }">
	...
	<div id="replyForm">
		<form name="replyWriteForm" id="replyWriteForm">				
			<input type="hidden" name="bbsNo" value="${ rNo }"/>
