...
<article>
   ...
   <form action="userUpdateResult.mvc" name="userUpdateForm" 
      id="userUpdateForm" method="post" >
      <input type="hidden" name="isIdCheck" value="true"/>
      <input type="hidden" name="isNickameCheck" id="isNicknameCheck" value="true"/>   
      ...
      <br/>
         ...
         <div class="userInputText">
            ...
            <input type="text" name="mId" size="15"  id="mId" readonly               
         ...
         <!-- 기존 비밀번호 -->         
         <div class="userInputText">
            <span class="userSpan"> 기존 비밀번호 : </span>
         ...
         <!-- 비밀번호 -->
         <div class="userInputText">
            <span class="userSpan"> 새 비밀번호 : </span>
         ...
         <!-- 비밀번호 확인  -->
         <div class="userInputText">
            <span class="userSpan"> 새 비밀번호 확인 : </span>
         ...
         <div class="userInputText">
            ...
            <input type="text" name="mNickname" size="15"  id="mNickname" readonly               
